...
body{font-family:'Montserrat',sans-serif;background:#f9fafb;color:#000;display:flex;justify-content:center;padding:2rem}
.inv{width:800px;min-height:1100px;background:#fff;display:flex;flex-direction:column;box-shadow:0 10px 40px rgba(0,0,0,.1);border:1px solid #e5e7eb}
.hdr{background:${color};color:#fff;padding:1.5rem;text-align:center;margin-bottom:2.5rem}
.hdr h1{font-size:1.8rem;font-weight:900;text-transform:uppercase;letter-spacing:.2em;margin-bottom:.25rem}
.hdr p{font-size:.6rem;font-weight:700;text-transform:uppercase;letter-spacing:.3em;opacity:.9}
.cnt{padding:0 3rem;flex-grow:1}
.bar{display:flex;justify-content:space-between;border-bottom:2px solid ${color};padding-bottom:.25rem;margin-bottom:2.5rem;font-weight:700;font-size:.7rem;text-transform:uppercase;color:#1e293b}
.ttl{color:${color};font-size:1.2rem;font-weight:900;margin-bottom:.75rem}
.cli{font-weight:700;font-size:.875rem;color:#1e293b;margin-bottom:2.5rem}
table{width:100%;border-collapse:collapse;margin-bottom:2rem;text-align:left}
thead tr{border-bottom:2px solid ${color}}
th{font-size:.6rem;font-weight:900;text-transform:uppercase;letter-spacing:.15em;color:#334155;padding:.5rem 0}
th:last-child{text-align:right}
td{padding:1.5rem 0;font-size:.75rem;vertical-align:top;color:#334155}
...
.pn{font-weight:700;font-size:.875rem;color:#1e293b;margin-bottom:.25rem}
.pd{font-size:.625rem;line-height:1.6;color:#334155}
tbody tr{border-bottom:1px solid #f1f5f9}
.tots{display:flex;justify-content:flex-end;margin-bottom:4rem}
.totb{width:12rem;font-size:.7rem;font-weight:700}
.totr{display:flex;justify-content:space-between;color:#334155;margin-bottom:.5rem}
.tott{display:flex;justify-content:space-between;border-top:2px solid #000;padding-top:.5rem;font-size:.875rem;font-weight:900;color:#1e293b}
.bank{font-size:.625rem;color:#1e293b;background:#f8fafc;padding:1rem;border-radius:.5rem;border:1px solid #f1f5f9;display:inline-block;margin-bottom:4rem;line-height:1.8}
.bank b{font-weight:900;color:#334155}
.bank .bt{font-weight:900;font-size:.7rem;color:#0f172a;text-transform:uppercase;letter-spacing:.1em;margin-bottom:.5rem}
.reg{font-size:.75rem;margin-bottom:8rem}
.reg p:first-child{color:#334155;font-weight:700;margin-bottom:.25rem}
.reg .nm{font-weight:900;font-size:.875rem;color:#1e293b}
.ftr{padding:2rem 3rem;display:flex;justify-content:space-between;color:${color};font-weight:900;font-size:.55rem;text-transform:uppercase;letter-spacing:.2em;border-top:1px solid #f8fafc}
...
.inv{box-shadow:none;border:none;width:100%;min-height:100vh}
...
.ftr{padding:1.5rem;flex-wrap:wrap;gap:.5rem;justify-content:center}
}
</style>
</head>
<body>
...
${profile?.bank_name ? `<div class="bank"><div class="bt">Banking Details:</div>
<div><b>Account Holder:</b> ${profile.bank_holder || name}</div>
<div><b>Bank Name:</b> ${profile.bank_name}</div>
${profile.bank_account ? `<div><b>Account number:</b> ${profile.bank_account}</div>` : ''}
${profile.bank_iban ? `<div><b>IBAN:</b> ${profile.bank_iban}</div>` : ''}
</div>` : ''}
